...
module ForemanThemeSatellite
  module Documentation
    USER_GUIDE_DICTIONARY = {
      ...
      'Realm' => "integrating_provisioning_infrastructure_services/index#configuring-project-to-manage-the-lifecycle-of-a-host-registered-to-a-freeipa-realm_satellite",
